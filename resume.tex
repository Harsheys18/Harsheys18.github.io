...
% \fi
\newgeometry{top = 53.09 mm, left = 14.11mm, right = 14.11mm, bottom=6.4mm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%				 First Page
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{Sakhi -- AI Companion Robot}{Technical Lead and Founding Member, Sakhi}{2025 - Current}{\textit{Robotics \& AI Startup, IDEAS Program, IIT Bombay}}
\begin{itemize}
    \item Building an \textbf{AI companion robot} integrating \textbf{multimodal perception, speech, LLM-based reasoning, and emotion recognition} for human--robot interaction
    \item Developing a real-time \textbf{perception-to-dialogue pipeline} combining \textbf{STT, facial emotion detection, conversational reasoning, and expressive TTS}
    \item Selected for \textbf{IDEAS Level 1}, advanced to \textbf{Level 2}, and secured \textbf{5 lakh rupees funding} to develop and validate 
\end{itemize}

\subsection{Quantitative Research}{Quantitative Researcher, Graviton}{May '26 - Jul '26}{\textit{Gurugram, India}}
\begin{itemize}
    \item Developed \textbf{portfolio optimization} algorithms for \textbf{long-short} strategies and systematic portfolio weight allocation
    \item Researched \textbf{ML-based alpha} signals across model configurations and made pipelines for \textbf{training, \& backtesting}
    \item Built a reusable \textbf{Python library} and interactive \textbf{UI} for team to run experiments and analyse alpha performance
\end{itemize}
...
\subsection{Perception and Reinforcement Learning based Control}{B.Tech. Project}{Jul '26 - Current}{\textit{BTP Project, Instructor: Prof. Nived Chebrolu, IIT Bombay}}
\begin{itemize}
\item Developing a \textbf{perception-to-control framework} for autonomous robots, integrating learned visual representations with \textbf{reinforcement learning} for robust decision-making and control.
\item Exploring \textbf{neuro-symbolic and hierarchical learning} approaches for long-horizon robot tasks, with emphasis on incorporating structured task constraints into learned policies.
\item Investigating \textbf{closed-loop learning} where perception and downstream control jointly adapt to improve robustness under partial observability and execution failures.
\end{itemize}
...
\subsection{Developing Backtester}{Summer of Quant}{May '26 - Jul '26}{\textit{Quant Club, IIT Bombay}}
\begin{itemize}
    \item 
\end{itemize}
...
\subsection{Made a Terrarover bot for space}{Summer of Robotics}{May '26 - Jul '26}{\textit{Electronics and Robotics Club, IIT Bombay}}
\begin{itemize}
    \item 
\end{itemize}
...
\subsectionthree{Institute Student Mentor}{Student Mentorship Program \textbar\ \textit{IIT Bombay}}{Jul '26 - Present}
\begin{itemize}
    \item 
\end{itemize}
